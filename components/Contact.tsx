        ...
        <div className="border-t border-zinc-900/60 pt-12 flex flex-col sm:flex-row items-center justify-between gap-6 text-[10px] md:text-xs font-mono text-zinc-600">
          <div className="flex items-center gap-3">
            {mounted ? (
              <svg
                viewBox="0 0 100 100"
                className="h-6 w-6 text-emerald-400 hover:text-emerald-300 transition-all duration-300 drop-shadow-[0_0_6px_rgba(16,185,129,0.4)]"
                fill="none"
              >
                <style>{`
                  ...
                  .footer-cursor {
                    animation: footerCursorBlink 1.1s step-end infinite;
                  }
                `}</style>
                {/* Sol Kanca (<) */}
                <path
